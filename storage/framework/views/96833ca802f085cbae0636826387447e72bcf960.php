<?php $__env->startSection('page_title', 'Add Primary Confirmation'); ?>
...
<?php $__env->startSection('sub_header'); ?>
    ...
    <?php echo $__env->make('admin.layouts.sub_header', [
        'title' => 'Add Primary Confirmation',
    ...
    <div class="card mb-5 mb-xl-5">
        <div class="card-header border-0">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Add Primary Confirmation</h3>
            </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/admin/payment/primary_confirmation/create.blade.php ENDPATH**/ ?>