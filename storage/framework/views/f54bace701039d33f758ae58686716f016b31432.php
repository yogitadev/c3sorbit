                ...
                <?php if(!is_null($breadcrumb_arr) && count($breadcrumb_arr) > 0): ?>
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 ms-2">
                        <li class="breadcrumb-item pe-3">
                            <a href="<?php echo e(route('front-dashboard')); ?>" class="text-muted text-hover-primary">
...
<?php /**PATH /home/hp/projects/edfyed/resources/views/front/layouts/sub_header.blade.php ENDPATH**/ ?>