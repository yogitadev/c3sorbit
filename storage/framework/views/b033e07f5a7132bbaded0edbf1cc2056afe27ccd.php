    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <h3 class="fw-bolder m-0">Pages</h3>
            </div>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <?php echo $__env->make('admin.cms.pages._filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                    <!--a href="<?php echo e(route('create-page')); ?>" class="btn btn-dark"><i class="fas fa-plus fs-4 me-1"></i>
                                                        Create</a-->
                </div>
            </div>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fs-7 w-150px py-4"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pages.edit')): ?>
                                            <div class="menu-item px-3">
                                                <a href="<?php echo e(route('edit-page', ['unique_id' => $item->unique_id])); ?>"
                                                    class="menu-link px-3">
                                                    <i class="fas fa-edit me-3"></i> Edit</a>
                                            </div>
                                        <?php endif; ?>
                                        <?php if($item->section_required == 'Yes'): ?>
                                            <div class="menu-item px-3">
                                                <a href="<?php echo e(route('section-list', ['page_unique_id' => $item->unique_id])); ?>"
                                                    class="menu-link px-3">
                                                    <i class="fas fa-list me-3"></i> Sections</a>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="<?php echo e(route('page-media-list', ['unique_id' => $item->unique_id])); ?>"
                                                class="menu-link px-3">
                                                <i class="fas fa-image me-3"></i> Media</a>
                                        </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/cms/pages/index.blade.php ENDPATH**/ ?>