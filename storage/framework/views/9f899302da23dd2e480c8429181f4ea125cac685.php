...
<?php $__env->startSection('content'); ?>
    ...
    <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
        ...
        <div class="fv-row mb-10">
            <a href="<?php echo e(route('admin-forget-password')); ?>">Forget Password ?</a>
        </div>
...
<?php echo $__env->make('admin.auth.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/auth/login/index.blade.php ENDPATH**/ ?>