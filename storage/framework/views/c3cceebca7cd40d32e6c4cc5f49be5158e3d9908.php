<?php $__env->startSection('page_title', 'Reorder Roles'); ?>
    ...
    <div class="card mb-5 mb-xl-5">
        <div class="card-header border-0">
            ...
            <div class="card-toolbar m-0">
                <a href="<?php echo e(route('role-list')); ?>" class="btn btn-danger"><i
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#btn-update-order').click(function() {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('reorder-role')); ?>',
                    data: {
                        'items': $items,
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/admin/iam/roles/reorder.blade.php ENDPATH**/ ?>