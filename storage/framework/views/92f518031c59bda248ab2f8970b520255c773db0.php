<?php $__env->startSection('page_title', 'Edit Approve Primary Confirmation'); ?>

<?php $__env->startSection('sub_header'); ?>
    <?php
    $breadcrumb_arr = [
        'Student Payment' => route('student-payment-list'),
        $item->unique_id => '',
        'Edit' => '',
    ];
    ?>
    <?php echo $__env->make('admin.layouts.sub_header', [
        'title' => 'Edit Approve Primary Confirmation',
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/admin/payment/primary_confirmation/edit_approve.blade.php ENDPATH**/ ?>