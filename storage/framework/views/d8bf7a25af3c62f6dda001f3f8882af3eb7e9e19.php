...
<div class="menu menu-sub menu-sub-dropdown w-25 " data-kt-menu="true">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-5">
            ...
            <?php echo Form::select('purpose_id', $purpose_list, $params['purpose_id'] ?? null, [
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo e(route('result-list')); ?>"
...
<?php /**PATH /home/hp/projects/edfyed/resources/views/admin/vista_update_management/results/_filter.blade.php ENDPATH**/ ?>