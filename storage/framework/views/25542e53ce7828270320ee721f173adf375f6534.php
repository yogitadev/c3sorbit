<?php $__env->startSection('page_title', 'Enquiries'); ?>
...
<?php $__env->startSection('header-menu'); ?>
    <?php echo $__env->make('admin.enquiry.includes.header_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <h3 class="fw-bolder m-0">Enquiries</h3>
            </div>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <?php echo $__env->make('admin.enquiry._filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fs-7 w-150px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="<?php echo e(route('show-enquiry', ['unique_id' => $item->unique_id])); ?>"
                                                class="menu-link px-3">
                                                <i class="fas fa-eye me-3"></i> Show</a>
                                        </div>

                                        <div class="menu-item px-3">
                                            <a href="<?php echo e(route('delete-enquiry', ['unique_id' => $item->unique_id])); ?>"
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/admin/enquiry/index.blade.php ENDPATH**/ ?>