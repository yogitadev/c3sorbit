<?php $__env->startSection('page_title', 'Lecture Schedules'); ?>
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <?php echo $__env->make('admin.cms.lecture_schedules._filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('lecture_schedules.edit')): ?>
                        <a href="<?php echo e(route('reorder-lecture-schedule')); ?>" class="btn btn-warning me-3"><i
                            class="fas fa-list fs-4 me-1"></i>
                        Reorder</a>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('lecture_schedules.add')): ?>
                    <a href="<?php echo e(route('create-lecture-schedule')); ?>" class="btn btn-dark"><i
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo e($item->lecture_date ?? '-'); ?> <?php echo e($item->lecture_time ?? '-'); ?>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fs-7 w-150px py-4"
                                        ...
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('lecture_schedules.delete')): ?>
                                            <div class="menu-item px-3">
                                                <a href="<?php echo e(route('delete-lecture-schedule', ['unique_id' => $item->unique_id])); ?>"
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/cms/lecture_schedules/index.blade.php ENDPATH**/ ?>