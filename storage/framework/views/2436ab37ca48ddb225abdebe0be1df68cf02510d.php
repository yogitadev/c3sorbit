        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('personnels.edit')): ?>
                        <a href="<?php echo e(route('reorder-personnel')); ?>" class="btn btn-warning me-3"><i
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fs-7 w-150px py-4"
                                            ...
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('personnels.delete')): ?>
                                                <?php if($item->admin_type == 'Admin'): ?>
                                                <div class="menu-item px-3">
                                                    <a href="<?php echo e(route('delete-personnel', ['unique_id' => $item->unique_id])); ?>"
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/admin/iam/personnel/index.blade.php ENDPATH**/ ?>