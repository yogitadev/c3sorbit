<div class="header-menu align-items-stretch d-flex justify-content-center">
    ...
    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
        ...
        <div
            class="menu-item ms-2 here <?php echo e(Request::is('admin/cms/subjects') || Request::is('admin/cms/subjects/*') ? 'show' : ''); ?>">
            <a class="menu-link py-3" href="<?php echo e(route('subject-list')); ?>">
                <span class="menu-title">Subjects</span>
            </a>
        </div>

        <div
            class="menu-item ms-2 here <?php echo e(Request::is('admin/cms/lecture-schedules') || Request::is('admin/cms/lecture-schedules/*') ? 'show' : ''); ?>">
            <a class="menu-link py-3" href="<?php echo e(route('lecture-schedule-list')); ?>">
                <span class="menu-title">Lecture Schedules</span>
            </a>
        </div>

        <div
            class="menu-item ms-2 here <?php echo e(Request::is('admin/cms/assignments') || Request::is('admin/cms/assignments/*') ? 'show' : ''); ?>">
            <a class="menu-link py-3" href="<?php echo e(route('assignment-list')); ?>">
...
<?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/cms/includes/header_menu.blade.php ENDPATH**/ ?>