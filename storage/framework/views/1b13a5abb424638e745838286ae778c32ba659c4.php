            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php echo e(Request::is('admin/cms/subjects') || Request::is('admin/cms/subjects/*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('subject-list')); ?>">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php echo e(Request::is('admin/cms/lecture-schedules') || Request::is('admin/cms/lecture-schedules/*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('lecture-schedule-list')); ?>">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php echo e(Request::is('admin/cms/assignments') || Request::is('admin/cms/assignments/*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('assignment-list')); ?>">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion <?php echo e(Request::is('admin/person/*') ? 'show' : ''); ?> ">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <i class="fas fa-newspaper fs-3"></i>
                        </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link <?php echo e(Request::is('admin/person/faculties') || Request::is('admin/person/faculties/*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('faculty-list')); ?>">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php echo e(Request::is('admin/person/students') || Request::is('admin/person/students/*') ? 'active' : ''); ?>"
...
<!--end::Aside-->
<?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>