<?php $__env->startSection('page_title', 'Create Lecture Schedule'); ?>
    ...
    <div class="card mb-5 mb-xl-5">
        <div class="card-header border-0">
            ...
            <div class="card-toolbar m-0">
                <a href="<?php echo e(route('lecture-schedule-list')); ?>" class="btn btn-danger"><i
                        class="fas fa-angle-left fs-4 me-2"></i> Go
                    Back</a>
            </div>
        </div>
        <div class="card-body border-top p-9">
            <?php echo $__env->make('admin.cms.lecture_schedules._form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/cms/lecture_schedules/create.blade.php ENDPATH**/ ?>