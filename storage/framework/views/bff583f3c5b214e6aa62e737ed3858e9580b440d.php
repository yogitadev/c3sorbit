<?php $__env->startSection('page_title', 'Target Managers'); ?>
    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <h3 class="fw-bolder m-0">Target Managers</h3>
            </div>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <?php echo $__env->make('admin.cms.target_managers._filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('target_managers.edit')): ?>
                    <a href="<?php echo e(route('reorder-target-manager')); ?>" class="btn btn-warning me-3"><i
                            class="fas fa-list fs-4 me-1"></i>
                        Reorder</a>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('target_managers.add')): ?>
                    <a href="<?php echo e(route('create-target-manager')); ?>" class="btn btn-dark"><i
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e($item->employee->first_name ?? '-'); ?> <?php echo e($item->employee->last_name ?? '-'); ?>
                                    ...
                                    <td>
                                        <?php echo e($item->region->region_name ?? '-'); ?>
                                    ...
                                    <td>
                                        <?php echo e($item->target_name); ?>

                                    </td>
                                    <td style="word-wrap: break-word;min-width: 600px;max-width: 600px;">
                                        <?php if($item->type == 'Region'): ?>
                                        
                                            <?php echo \App\Helpers\Helper::region_country_name($item->region->country_ids); ?>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fs-7 w-150px py-4"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('target_managers.edit')): ?>
                                                <div class="menu-item px-3">
                                                    <a href="<?php echo e(route('edit-target-manager', ['unique_id' => $item->unique_id])); ?>"
                                                        class="menu-link px-3">
                                                        <i class="fas fa-edit me-3"></i> Edit</a>
                                                </div>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('target_managers.delete')): ?>
                                                <div class="menu-item px-3">
                                                    <a href="<?php echo e(route('delete-target-manager', ['unique_id' => $item->unique_id])); ?>"
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/admin/cms/target_managers/index.blade.php ENDPATH**/ ?>