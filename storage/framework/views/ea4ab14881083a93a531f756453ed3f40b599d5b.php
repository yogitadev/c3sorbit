...
<div class="menu menu-sub menu-sub-dropdown " data-kt-menu="true">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-5">
            <label class="form-label fs-6 fw-bold">State:</label>

            <?php echo Form::select('state_id', $state_list, $params['state_id'] ?? null, [
    ...
    'data-hide-search' => 'true',
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo e(route('city-list')); ?>"
...
<?php /**PATH /home/hp/projects/edfyed/resources/views/admin/cms/cities/_filter.blade.php ENDPATH**/ ?>