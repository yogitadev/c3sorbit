...
<div class="menu menu-sub menu-sub-dropdown " data-kt-menu="true">
    ...
    <div class="scroll-y mh-325px px-7 py-5">
        ...
        <div class="mb-5">
            ...
            <?php echo Form::select('programcode_id', $programcode_list, $params['programcode_id'] ?? null, [
        ...
        <div class="mb-5">
            ...
            <?php echo Form::select('subject_id', $subject_list, $params['subject_id'] ?? null, [
                'class' => 'form-select form-select-solid fw-bolder select2-hidden-accessible',
                'data-kt-select2' => 'true',
                'data-placeholder' => 'Select option',
                'data-allow-clear' => 'true',
    ...
    'data-hide-search' => 'true',
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo e(route('lecture-schedule-list')); ?>"
...
<?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/cms/lecture_schedules/_filter.blade.php ENDPATH**/ ?>