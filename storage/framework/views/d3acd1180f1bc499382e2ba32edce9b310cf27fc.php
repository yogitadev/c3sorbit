<?php $__env->startSection('page_title', 'Add Student Course'); ?>
    ...
    <div class="card mb-5 mb-xl-5">
        <div class="card-header border-0">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Add Student Course</h3>
            </div>
        ...
        <div class="card-body border-top p-9">
            <?php echo $__env->make('admin.letter.conditional_letters._form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/admin/letter/conditional_letters/create.blade.php ENDPATH**/ ?>