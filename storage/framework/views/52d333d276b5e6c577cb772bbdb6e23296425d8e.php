<div class="row">
    <div class="col-md-6 mb-5">
        ...
        <?php echo Form::text('shortname', null, ['class' => 'form-control', 'required' => true]); ?>
    ...
    <div class="col-md-6 mb-5">
        ...
        <?php echo Form::text('phonecode', null, ['class' => 'form-control', 'required' => true]); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/cms/countries/_form.blade.php ENDPATH**/ ?>