        ...
        <main>
            ...
            <table style="border: 1px solid black; border-spacing: 3px;">
                <tbody style="margin: 5px;">
                    ...
                    <!-- <tr>
                        <td>First Year Tuition Fees </td>
                        <td class='tdpadding'>: &#8364;6,500</td>
                    </tr>
                    <tr>
                        <td>Second Year Tuition Fees </td>
                        <td class='tdpadding'>: &#8364;6,500</td>
                    </tr>
                    <tr>
                        <td>Third Year Tuition Fees</td>
                        <td class='tdpadding'>: &#8364;6,500</td>
                    </tr>
                    <tr>
                        <td>First Instalment </td>
                        <td class='tdpadding'>: &#8364;4,500 (Paid)</td>
                    </tr> -->
                    <tr>
...
<?php /**PATH /home/hp/projects/edfyed/resources/views/admin/letter/conditional_letters/ucol(css).blade.php ENDPATH**/ ?>