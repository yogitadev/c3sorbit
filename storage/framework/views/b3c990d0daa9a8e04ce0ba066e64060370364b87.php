<?php $__env->startSection('page_title', 'Campagins'); ?>
    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <h3 class="fw-bolder m-0">Campagins</h3>
            </div>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <?php echo $__env->make('front.campaign.campaigns._filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('campagins.add')): ?>
                        <a href="<?php echo e(route('create-campaign')); ?>" class="btn btn-dark"><i
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">
                                <?php echo \App\Helpers\Helper::getColumnSortLink([
                                    ...
                                    'column_title' => 'Original Campaign ID',
                                    'column_name' => 'original_campaign_id',
                                    'params' => $params,
                                ]); ?>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php if(!is_null($item->original_campaign_id)): ?>
                                    <?php echo e($item->original_campaign_id); ?>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fs-7 w-150px py-4"
                                        data-kt-menu="true">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('campagins.edit')): ?>
                                            <div class="menu-item px-3">
                                                <a href="<?php echo e(route('edit-campaign', ['unique_id' => $item->unique_id])); ?>"
                                                    class="menu-link px-3">
                                                    <i class="fas fa-edit me-3"></i> Edit</a>
                                            </div>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('campagins.delete')): ?>
                                            <div class="menu-item px-3">
                                                <a href="<?php echo e(route('delete-campaign', ['unique_id' => $item->unique_id])); ?>"
...
<?php echo $__env->make('front.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/front/campaign/campaigns/index.blade.php ENDPATH**/ ?>