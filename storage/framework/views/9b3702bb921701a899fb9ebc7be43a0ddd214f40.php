<?php $__env->startSection('page_title', 'CreateSubject Type'); ?>

<?php $__env->startSection('sub_header'); ?>
    <?php
    $breadcrumb_arr = [
        'Subject Types' => route('subject-type-list'),
        'Create' => '',
    ];
    ?>
    ...
    <div class="card mb-5 mb-xl-5">
        <div class="card-header border-0">
            ...
            <div class="card-toolbar m-0">
                <a href="<?php echo e(route('subject-type-list')); ?>" class="btn btn-danger"><i
                        class="fas fa-angle-left fs-4 me-2"></i> Go
                    Back</a>
            </div>
        </div>
        <div class="card-body border-top p-9">
            <?php echo $__env->make('admin.vista_update_management.subject_types._form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/admin/vista_update_management/subject_types/create.blade.php ENDPATH**/ ?>