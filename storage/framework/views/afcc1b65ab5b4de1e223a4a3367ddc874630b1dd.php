<?php $__env->startSection('page_title', 'Reorder Qualifications'); ?>

<?php $__env->startSection('sub_header'); ?>
    <?php
    $breadcrumb_arr = [
        'Qualifications' => route('qualification-list'),
        'Reorder' => '',
    ];
    ?>
    <?php echo $__env->make('admin.layouts.sub_header', [
        'title' => 'Reorder Qualifications',
    ...
    <div class="card mb-5 mb-xl-5">
        <div class="card-header border-0">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Reorder Qualifications</h3>
            </div>

            <div class="card-toolbar m-0">
                <a href="<?php echo e(route('qualification-list')); ?>" class="btn btn-danger"><i
        ...
        <?php else: ?>
            <div class="card-body border-top p-9">
                <h4 class="text-danger text-center">No Qualification Found</h4>
            </div>
        <?php endif; ?>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#btn-update-order').click(function() {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('reorder-qualification')); ?>',
                    data: {
                        'items': $items,
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/admin/cms/qualifications/reorder.blade.php ENDPATH**/ ?>