...
<div class="menu menu-sub menu-sub-dropdown " data-kt-menu="true">
    ...
    <div class="scroll-y mh-325px px-7 py-5">
        ...
        <div class="mb-5">
            ...
            <?php echo Form::select('search_status', ['' => '', 'Pending' => 'Pending', 'Active' => 'Active', 'Inactive' => 'Inactive', 'Deleted' => 'Deleted'], $params['search_status'] ?? null, [
    ...
    'data-hide-search' => 'true',
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo e(route('personnel-list')); ?>"
...
<?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/iam/personnel/_filter.blade.php ENDPATH**/ ?>