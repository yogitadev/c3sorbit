...
$(function() {
    $(document.body).on("change","#parent_role_id",function(){
        ...
        $.ajax({
                type: 'GET',
                url: '<?php echo e(route('create-personnel')); ?>'+'?role_id='+role_id,
                success: function(e) {
                    console.log(e);
                    $('#parent_type_id')
    ...
    $(document.body).on("change","#parent_home_country_id",function(){
        ...
        $.ajax({
                type: 'GET',
                url: '<?php echo e(route('create-personnel')); ?>'+'?country_id='+country_id,
                success: function(e) {
                    console.log(e);
    ...
    $(document.body).on("change","#parent_home_state_id",function(){
        ...
        $.ajax({
                type: 'GET',
                url: '<?php echo e(route('create-personnel')); ?>'+'?state_id='+state_id,
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/edfyed/resources/views/admin/iam/personnel/create.blade.php ENDPATH**/ ?>