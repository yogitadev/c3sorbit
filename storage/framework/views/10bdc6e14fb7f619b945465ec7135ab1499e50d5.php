...
<html lang="en">
    ...
    <body>
        ...
        <header>
            ...
            <?php
                    $path = 'themes/admin/images/aspirebarcelonalogo.png';
            ...
            <table style="width: 100%;">
                <tr>
                    <td><img src="<?php echo $logo?>" alt="logo" width="100" height="100" style=""></td>
                </tr>
                <tr>
                    <td>
                        <hr style="color:blue;"> 
        ...
        <footer>
            ...
            <span style="text-align: center;">
                By scanning QR Code, this offer letter of can be viewed on edfyedops.com
            </span><br>
        </footer>
        <main>
            <h3 style="text-align: center;">UNCONDITIONAL OFFER LETTER</h3>
            ...
            <table style="border: 1px solid black; border-spacing: 3px;">
                <tbody style="margin: 5px;">
                    ...
                    <tr>
                        <td><b>Registration Fees Paid</b></td>
                        <td class='tdpadding'>: &#8364;<?php echo e($data['approve_registration_fees']); ?></td>
                    </tr>
                    <tr>
                    ...
                    <!-- <tr>
                        ...
                        <td class='tdpadding'>: &#8364;4,000 (Paid)</td>
                    </tr> -->
                    <tr>
                        <td><b>Total Tuition Fees Paid </b></td>
                        <td class='tdpadding'>: &#8364;<?php echo e($data['approve_tutuion_fees']); ?></td>
                    </tr>
                    <tr>
                        <td><b>Pending Fees </b></td>
                        <td class='tdpadding'>: &#8364;<?php echo e($data['pending_fees']); ?></td>
                    </tr> 
                </tbody>
            </table>
            <br>
            <br>
            <b>Please notice that the signed student contract is mandatory to confirm the place of offer.</b>
            ...
            <p>Aspire Business School will acknowledge receipt of your acceptance form within 14 days of reception. If you do not receive an acknowledgement within this period, please contact us immediately.</p>
            ...
            <p>
                <?php
                    $path = 'themes/admin/images/ABSsignature.png';
            ...
            <span>Aspire Business School (ABS),</span><br>
            <span> Barcelona Spain</span>
        </main>
    </body>
</html>
<?php /**PATH /home/hp/projects/edfyed/resources/views/admin/letter/conditional_letters/ucol(aspire).blade.php ENDPATH**/ ?>