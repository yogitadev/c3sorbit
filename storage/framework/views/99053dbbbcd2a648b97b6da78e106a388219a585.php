<?php $__env->startSection('page_title', 'Programcodes'); ?>
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <?php echo $__env->make('admin.course.programcodes._filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programcodes.edit')): ?>
                        <a href="<?php echo e(route('reorder-programcode')); ?>" class="btn btn-warning me-3"><i
                                class="fas fa-list fs-4 me-1"></i>
                            Reorder</a>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programcodes.add')): ?>
                        <a href="<?php echo e(route('create-programcode')); ?>" class="btn btn-dark"><i
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                <?php if(!is_null($item->program_name)): ?><?php echo e($item->program_name); ?>

                                <?php else: ?> -
                                <?php endif; ?>
                                </td>
                                <td>
                                    <?php echo e($item->program_code); ?>

                                </td>
                                <td>
                                    <?php echo e($item->institution->name); ?>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fs-7 w-150px py-4"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programcodes.edit')): ?>
                                            <div class="menu-item px-3">
                                                <a href="<?php echo e(route('edit-programcode', ['unique_id' => $item->unique_id])); ?>"
                                                    class="menu-link px-3">
                                                    <i class="fas fa-edit me-3"></i> Edit</a>
                                            </div>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programcodes.delete')): ?>
                                            <div class="menu-item px-3">
                                                <a href="<?php echo e(route('delete-programcode', ['unique_id' => $item->unique_id])); ?>"
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/course/programcodes/index.blade.php ENDPATH**/ ?>