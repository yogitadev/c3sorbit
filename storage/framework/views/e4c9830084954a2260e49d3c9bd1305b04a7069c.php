...
<div class="menu menu-sub menu-sub-dropdown  w-250px w-md-700px" data-kt-menu="true">
    ...
    <div class="scroll-y mh-325px px-7 py-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-5">
                    ...
                    <?php echo Form::select('module_category_id', $category_list, $params['module_category_id'] ?? null, [
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo e(route('module-list')); ?>"
...
<?php /**PATH /home/hp/projects/c3sorbit/resources/views/admin/iam/modules/_filter.blade.php ENDPATH**/ ?>