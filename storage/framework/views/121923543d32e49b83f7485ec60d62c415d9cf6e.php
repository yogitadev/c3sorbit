...
<div class="menu menu-sub menu-sub-dropdown " data-kt-menu="true">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-5">
            ...
            <?php echo Form::select('search_type', ['' => '', 'B2B' => 'B2B', 'B2C' => 'B2C'], $params['search_type'] ?? null, [
    ...
    'data-hide-search' => 'true',
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo e(route('purpose-list')); ?>"
...
<?php /**PATH /home/hp/projects/edfyed/resources/views/admin/vista_update_management/purposes/_filter.blade.php ENDPATH**/ ?>